...
$bton.click(function(event) {
	...
	$texto.onloadend = (function (argument) {
        ...
        var expresion = /\w+\s\w+\-\w+(?=\,)|\w+\/\w+\-\w+\/\w+(?=\,)|\d+\,\d+(?=\")|\w+\/\w+(?=\,)|\w+\-\w+(?=\,)|\w+(?=\,)|\d+\s\d+(?=\,)|\-(?=\,)|\w+(?=\r\,)|\d+\,\d+(?="\r\,)/gi;
        ...
        productos.forEach(function(producto) {
			...
			"</td>\n"+
			"<td style=\"text-align: center;\" width=\"69\" height=\"16\">\n"+
			"<h6><strong><span style=\"color: #333333;\">d3</span></strong></h6>\n"+
			"</td>\n"+
			"<td style=\"text-align: center;\" width=\"69\" height=\"16\">\n"+
			"<h6><strong><span style=\"color: #333333;\">B</span></strong></h6>\n"+
			"</td>\n"+			
			"<td style=\"text-align: center;\" width=\"69\" height=\"16\">\n"+
			"<h6><strong><span style=\"color: #333333;\">T1</span></strong></h6>\n"+
			"</td>\n"+
