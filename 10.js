...
$bton.click(function(event) {
	...
	$texto.onloadend = (function (argument) {
        ...
        var expresion = /\d+\,\d+(?=\")|\w+\/\w+(?=\,)|\w+(?=\,)|\d+\-\w+(?=\,)|\d+\s\d+(?=\,)|\-(?=\,)|\w+\s\w+(?=\r\,)|\d+\,\d+(?="\r\,)/gi;
        ...
        productos.forEach(function(producto) {
			...
			"<h6><span style=\"color: #ffffff;\"><strong>Capacidad elemental de carga<img class=\"aligncenter wp-image-524\" src=\"http://zkl.com.mx/wp-2017/wp-content/uploads/2017/05/zkl-D.png\" alt=\"\" width=\"25\" height=\"25\"></strong></span></h6>\n"+
			"</td>\n"+
			"<td style=\"text-align: center;\" colspan=\"2\">\n"+
			"<h6><span style=\"color: #ffffff;\"><strong>Velocidad de giro para lubricación <img class=\"aligncenter wp-image-521\" src=\"http://zkl.com.mx/wp-2017/wp-content/uploads/2017/05/zkl-velocidad.png\" alt=\"\" width=\"25\" height=\"25\"></strong></span></h6>\n"+
			"</td>\n"+
			"</tr>\n"+
			"<tr bgcolor=\"#848484\">\n"+
			"<td style=\"text-align: center;\" width=\"69\" height=\"16\">\n"+
			"<h6><strong><span style=\"color: #333333;\">d</span></strong></h6>\n"+
			"</td>\n"+
			...
			"</td>\n"+
			"<td style=\"text-align: center;\" width=\"80\">\n"+
			"<h6><span style=\"color: #333333;\"><strong>T</strong></span></h6>\n"+
			"</td>\n"+
			"<td style=\"text-align: center;\" width=\"117\">\n"+
			"<h6><span style=\"color: #333333;\"><strong>Dinámica (Cr)</strong></span></h6>\n"+
			"</td>\n"+
			...
			"<td></td>\n"+
			"<td colspan=\"1\">\n"+
			"<h6 style=\"text-align: center;\"><span style=\"text-align: center; size: 14px; color: #ffffff;\">kN</span></h6>\n"+
			"</td>\n"+
			"<td></td>\n"+
			"<td>\n"+
